...
export const PreRegistrationSection = forwardRef<HTMLDivElement>((props, ref) => {
  ...
  return (
    <>
      <div ref={ref} id="register" className="relative w-full min-h-[608px] sm:min-h-[600px] md:h-[608px] bg-[#00000080] py-12 sm:py-16 md:py-20 transition-all duration-300">
