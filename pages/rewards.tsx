...
export default function Rewards() {
  const exclusiveRewards = [
    {
      ...
      description: "Exclusive mythical weapons only available to pre-registered players",
    ...
    },
    {
      ...
      description: "Complete armor collection with mystical enchantments and unique appearance",
    ...
    },
    {
      ...
      description: "Soar through the skies on this majestic creature with ethereal wings",
    ...
    },
    {
      ...
      description: "Display your status as an original MYRK adventurer with this prestigious title",
    ...
    },
    {
      ...
      description: "1000 Myrk Crystals to enhance your gameplay experience from day one",
    ...
    },
    {
      ...
      description: "Special celebration animations and gestures unique to pre-registered players",
  ...
  const getRarityColor = (rarity: string) => {
    switch (rarity) {
      case "Legendary": return "from-[#ff6b35] to-[#f7931e]";
      case "Mythic": return "from-[#9d4edd] to-[#c77dff]";
      case "Epic": return "from-[#3d5a80] to-[#98c1d9]";
      case "Rare": return "from-[#2d6a4f] to-[#52b788]";
      case "Premium": return "from-[#edc84f] to-[#c79c27]";
      case "Unique": return "from-[#e63946] to-[#f77f00]";
      default: return "from-[#6c757d] to-[#495057]";
    }
  };
  ...
  return (
    <>
      <Head>
        <title>MYRK Rewards - Exclusive Pre-Registration Benefits & Items</title>
        <meta name="description" content="Unlock exclusive MYRK rewards through pre-registration including legendary weapons, rare items, early access benefits, and special in-game content." />
        <meta name="keywords" content="MYRK rewards, pre-registration benefits, exclusive items, legendary weapons, early access, in-game rewards" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        
        {/* Open Graph tags */}
        <meta property="og:title" content="MYRK Rewards - Exclusive Pre-Registration Benefits & Items" />
        <meta property="og:description" content="Unlock exclusive MYRK rewards through pre-registration including legendary weapons, rare items, early access benefits, and special in-game content." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://myrk-game.com/rewards" />
        <meta property="og:image" content="https://myrk-game.com/rewards-og-image.jpg" />
        
        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="MYRK Rewards - Exclusive Pre-Registration Benefits & Items" />
        <meta name="twitter:description" content="Unlock exclusive MYRK rewards through pre-registration including legendary weapons, rare items, early access benefits, and special in-game content." />
        <meta name="twitter:image" content="https://myrk-game.com/rewards-twitter-image.jpg" />
            ...
            {exclusiveRewards.map((reward, index) => (
              ...
              >
                <CardContent className="p-6 h-full flex flex-col relative">
                  {/* Rarity Badge */}
                  <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-semibold text-white bg-gradient-to-r ${getRarityColor(reward.rarity)}`}>
                    {reward.rarity}
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-gray-400 [font-family:'Oxanium',Helvetica]">Value:</span>
                      <span className="text-sm text-[#edc84f] [font-family:'Oxanium',Helvetica] font-semibold">{reward.value}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-gray-400 [font-family:'Oxanium',Helvetica]">Unlocked:</span>
                      <span className="text-sm text-green-400 [font-family:'Oxanium',Helvetica]">{reward.unlocked}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            {milestones.map((milestone, index) => (
              <div key={index} className={`flex items-center p-6 rounded-2xl border transition-all duration-300 ${
                milestone.achieved 
                  ? 'bg-[#edc84f08] border-[#edc84f40] shadow-lg shadow-[#edc84f]/20' 
                  : 'bg-[#ffffff08] border-[#ffffff15]'
              }`}>
                <div className={`w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold [font-family:'Orbitron',Helvetica] mr-6 ${
                  milestone.achieved 
                ...
                <div className="flex-grow">
                  <h3 className={`text-xl [font-family:'Oxanium',Helvetica] font-semibold mb-1 ${
                ...
                <div className={`px-4 py-2 rounded-full text-sm font-semibold [font-family:'Oxanium',Helvetica] ${
                  milestone.achieved 
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl [font-family:'Oxanium',Helvetica] font-medium text-gray-300 mb-8">
            Pre-register now to secure all exclusive rewards worth $149.94 - completely free
          </p>
