...
export default function Community() {
  const socialPlatforms = [
    {
      name: "Discord",
      description: "Join our vibrant Discord community for real-time discussions, events, and exclusive content.",
      members: "50K+ Members",
    ...
    {
      name: "Reddit",
      description: "Discuss strategies, share content, and connect with fellow adventurers in our subreddit.",
      members: "15K+ Members",
    ...
    {
      name: "YouTube",
      description: "Watch gameplay videos, developer diaries, and community showcases on our channel.",
    ...
    {
      name: "Instagram",
      description: "Visual updates, concept art, and behind-the-scenes glimpses of MYRK's development.",
    ...
    {
      name: "TikTok",
      description: "Quick gameplay clips, developer insights, and community challenges in short-form content.",
  ...
  const communityFeatures = [
    {
      title: "Guild System",
      description: "Form alliances with other players, participate in guild wars, and share resources.",
      icon: "/figmaAssets/frame-2.svg"
    },
    {
      title: "Player Events",
      description: "Join seasonal events, tournaments, and community challenges with exclusive rewards.",
      icon: "/figmaAssets/frame-3.svg"
    },
    {
      title: "Content Creation",
      description: "Share your adventures through screenshots, videos, and fan art with the community.",
      icon: "/figmaAssets/frame-4.svg"
    },
    {
      title: "Developer Interaction",
      description: "Direct communication with our development team through AMAs and feedback sessions.",
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Join the MYRK gaming community! Connect with fellow players, share strategies, participate in events, and stay updated with the latest news and announcements." />
        <meta name="keywords" content="MYRK community, gaming community, player connection, game events, news updates, discord community" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        
        {/* Open Graph tags */}
        <meta property="og:title" content="MYRK Community - Join Our Gaming Community & Connect" />
        <meta property="og:description" content="Join the MYRK gaming community! Connect with fellow players, share strategies, participate in events, and stay updated with the latest news and announcements." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://myrk-game.com/community" />
        <meta property="og:image" content="https://myrk-game.com/community-og-image.jpg" />
        
        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="MYRK Community - Join Our Gaming Community & Connect" />
        <meta name="twitter:description" content="Join the MYRK gaming community! Connect with fellow players, share strategies, participate in events, and stay updated with the latest news and announcements." />
        <meta name="twitter:image" content="https://myrk-game.com/community-twitter-image.jpg" />
            ...
            {socialPlatforms.map((platform, index) => (
              ...
              >
                <CardContent className="p-6 h-full flex flex-col">
                  <div className={`w-16 h-16 rounded-xl bg-gradient-to-r ${platform.color} flex items-center justify-center mb-6 transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-[#edc84f]/50`}>
                    <img
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl [font-family:'Oxanium',Helvetica] font-medium text-gray-300 mb-8">
            Subscribe to our newsletter for exclusive updates and community events
          </p>
